...
def setup(options):
    ...
    cons = consistency_split.cosmology_consistency(verbose, relations_file, cosmomc_theta, extra_relations)
...
def execute(block, config):
    ...
    except consistency_split.UnderSpecifiedModel as error:
        print("\nYou did not set enough cosmological parameters")
        print("to be able to deduce the rest of them:")
        print(error)
        return 1
    except consistency_split.OverSpecifiedModel as error:
