...
COSMOLOGY_CONSISTENCY_RELATIONS = [
    ("omega_m_early", "ommh2/h0/h0"),
    ("omega_b", "ombh2/h0/h0"),
    ("omega_c", "omch2/h0/h0"),
    ("omega_nu", "omnuh2/h0/h0"),
    ("ommh2", "omega_m_early*h0*h0"),
    ("ombh2", "omega_b*h0*h0"),
    ("omch2", "omega_c*h0*h0"),
    ...
    ("baryon_fraction", "omega_b/omega_m_early"),
    ("omega_b", "omega_m_early*baryon_fraction"),
    ("omega_m_early", "omega_b/baryon_fraction"),
    ("baryon_fraction", "ombh2/ommh2"),
    ("ombh2", "ommh2*baryon_fraction"),
    ("ommh2", "ombh2/baryon_fraction"),
    ("omega_m_early", "omega_b+omega_c+omega_nu"),
    ("omega_b", "omega_m_early-omega_c-omega_nu"),
    ("omega_c", "omega_m_early-omega_b-omega_nu"),
    ("omega_nu", "omega_m_early-omega_b-omega_c"),
    ("h0", "(ommh2/omega_m_early)**0.5"),
    ...
    ("omega_lambda", "1-omega_m_early-omega_k"),
    ("omega_m_early", "1-omega_lambda-omega_k"),
    ("omega_k", "1-omega_m_early-omega_lambda"),
...
def test_defaults():
    import nose
    consistency = cosmology_consistency()
    p = {"omega_m_early": 0.3, "hubble": 72., "baryon_fraction": 0.02}
    q = consistency(p)


def test_fully_specified():
    consistency = cosmology_consistency()
    p = {"omega_m_early": 0.3, "hubble": 72., "omega_b": 0.04, "omega_k": 0.0}
    q = consistency(p)
    r = consistency(q)
    assert q == r
...
def test_over_specified():
    import nose
    consistency = cosmology_consistency()
    p = {"omega_m_early": 0.3, "hubble": 72., "omega_b": 0.04, "omega_c": 0.1}
