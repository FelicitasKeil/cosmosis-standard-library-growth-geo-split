    ...
    def build_data(self):
        ...
        for spectrum in self.two_point_data.spectra:
            ...
            if spectrum.name=="wtheta":
                ...
                with open("w_theta_om-geo-025-growth-03-early-03.pkl", "rb") as in_pkl:
                    w_theta_geo_025_gr_03_ear_03 = pickle.load(in_pkl)
                with open("w_theta_om-geo-035-growth-03-early-03.pkl", "rb") as in_pkl:
                ...
                plt.savefig('w-of-theta-bin-1-1_all.png', dpi=300)
                plt.clf()
            if spectrum.name=="gammat":
                ...
                with open("gamma_t_om-geo-03-growth-025-early-03.pkl", "rb") as in_pkl:
                    gamma_t_geo_03_gr_025_ear_03 = pickle.load(in_pkl)
                with open("gamma_t_om-geo-03-growth-035-early-03.pkl", "rb") as in_pkl:
                    gamma_t_geo_03_gr_035_ear_03 = pickle.load(in_pkl)
                with open("gamma_t_om-geo-025-growth-03-early-03.pkl", "rb") as in_pkl:
                    gamma_t_geo_025_gr_03_ear_03 = pickle.load(in_pkl)
                with open("gamma_t_om-geo-035-growth-03-early-03.pkl", "rb") as in_pkl:
                ...
                plt.savefig('gamma-t-of-theta-bin-1-4_all.png', dpi=300)
                plt.clf()
            if spectrum.name=="xip":
                ...
                with open("xi_plus_om-geo-03-growth-025-early-03.pkl", "rb") as in_pkl:
                    xi_plus_geo_03_gr_025_ear_03 = pickle.load(in_pkl)
                with open("xi_plus_om-geo-03-growth-035-early-03.pkl", "rb") as in_pkl:
                    xi_plus_geo_03_gr_035_ear_03 = pickle.load(in_pkl)
                with open("xi_plus_om-geo-025-growth-03-early-03.pkl", "rb") as in_pkl:
                    xi_plus_geo_025_gr_03_ear_03 = pickle.load(in_pkl)
                with open("xi_plus_om-geo-035-growth-03-early-03.pkl", "rb") as in_pkl:
                ...
                plt.savefig('xi-plus-of-theta-bin-4-4_all.png', dpi=300)
                plt.clf()
            if spectrum.name=="xim":
                ...
                with open("xi_minus_om-geo-03-growth-025-early-03.pkl", "rb") as in_pkl:
                    xi_minus_geo_03_gr_025_ear_03 = pickle.load(in_pkl)
                with open("xi_minus_om-geo-03-growth-035-early-03.pkl", "rb") as in_pkl:
                    xi_minus_geo_03_gr_035_ear_03 = pickle.load(in_pkl)
                with open("xi_minus_om-geo-025-growth-03-early-03.pkl", "rb") as in_pkl:
                    xi_minus_geo_025_gr_03_ear_03 = pickle.load(in_pkl)
                with open("xi_minus_om-geo-035-growth-03-early-03.pkl", "rb") as in_pkl:
                ...
                plt.legend(prop={'size': 7})
                plt.title(r'Weak Lensing Bin 4-4')
                plt.savefig('xi-minus-of-theta-bin-4-4_all.png', dpi=300)
                plt.clf()
