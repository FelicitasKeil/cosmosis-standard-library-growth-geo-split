    ...
    def build_data(self):
        ...
        for spectrum in self.two_point_data.spectra:
            ...
            if spectrum.name=="wtheta":
                theta, w = spectrum.get_pair(1, 1)
                error = spectrum.get_error(1, 1)
                with open("thetas.pkl", "rb") as in_pkl:
                    thetas = pickle.load(in_pkl)
                with open("w_theta_om-geo-03-growth-03-early-03.pkl", "rb") as in_pkl:
                    w_theta_geo_03_gr_03_ear_03 = pickle.load(in_pkl)
                with open("w_theta_om-geo-03-growth-025-early-03.pkl", "rb") as in_pkl:
                    w_theta_geo_03_gr_025_ear_03 = pickle.load(in_pkl)
                with open("w_theta_om-geo-03-growth-035-early-03.pkl", "rb") as in_pkl:
                    w_theta_geo_03_gr_035_ear_03 = pickle.load(in_pkl)
                with open("w_theta_om-geo-025-growth-03-early-03_2om.pkl", "rb") as in_pkl:
                    w_theta_geo_025_gr_03_ear_03 = pickle.load(in_pkl)
                with open("w_theta_om-geo-035-growth-03-early-03_2om.pkl", "rb") as in_pkl:
                    w_theta_geo_035_gr_03_ear_03 = pickle.load(in_pkl)
                # with open("w_theta_om-geo-03-growth-03-early-025.pkl", "rb") as in_pkl:
                #     w_theta_geo_03_gr_03_ear_025 = pickle.load(in_pkl)
                # with open("w_theta_om-geo-03-growth-03-early-035.pkl", "rb") as in_pkl:
                #     w_theta_geo_03_gr_03_ear_035 = pickle.load(in_pkl)
                plt.errorbar(np.degrees(theta) * 60, w, yerr=error, marker="o",
                             linestyle="none", label="Data Points",
                             color="grey")
                plt.plot(thetas, w_theta_geo_03_gr_03_ear_03,
                    label="$\\Omega_{\\rm m}=0.3$", color="black")
                # plt.plot(thetas, w_theta_geo_03_gr_025_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.25, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, w_theta_geo_03_gr_035_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.35, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, w_theta_geo_025_gr_03_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.25, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, w_theta_geo_035_gr_03_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.35, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, w_theta_geo_03_gr_03_ear_025,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.25$")
                # plt.plot(thetas, w_theta_geo_03_gr_03_ear_035,
                ...
                plt.title(r'Galaxy Clustering Bin 1-1')
                plt.savefig('w-of-theta-bin-1-1_all_2om_prefactor.png', dpi=300)
                plt.clf()
            if spectrum.name=="gammat":
                theta, gamma_t = spectrum.get_pair(1, 4)
                error = spectrum.get_error(1, 4)
                with open("thetas.pkl", "rb") as in_pkl:
                    thetas = pickle.load(in_pkl)
                with open("gamma_t_om-geo-03-growth-03-early-03.pkl", "rb") as in_pkl:
                    gamma_t_geo_03_gr_03_ear_03 = pickle.load(in_pkl)
                with open("gamma_t_om-geo-03-growth-025-early-03_prefactor.pkl", "rb") as in_pkl:
                    gamma_t_geo_03_gr_025_ear_03 = pickle.load(in_pkl)
                with open("gamma_t_om-geo-03-growth-035-early-03_prefactor.pkl", "rb") as in_pkl:
                    gamma_t_geo_03_gr_035_ear_03 = pickle.load(in_pkl)
                with open("gamma_t_om-geo-025-growth-03-early-03_prefactor_2om.pkl", "rb") as in_pkl:
                    gamma_t_geo_025_gr_03_ear_03 = pickle.load(in_pkl)
                with open("gamma_t_om-geo-035-growth-03-early-03_prefactor_2om.pkl", "rb") as in_pkl:
                    gamma_t_geo_035_gr_03_ear_03 = pickle.load(in_pkl)
                # with open("gamma_t_om-geo-03-growth-03-early-025.pkl", "rb") as in_pkl:
                #     gamma_t_geo_03_gr_03_ear_025 = pickle.load(in_pkl)
                # with open("gamma_t_om-geo-03-growth-03-early-035.pkl", "rb") as in_pkl:
                #     gamma_t_geo_03_gr_03_ear_035 = pickle.load(in_pkl)
                plt.errorbar(np.degrees(theta) * 60, gamma_t, yerr=error,
                             marker="o", linestyle="none", label="Data Points",
                             color="grey")
                plt.plot(thetas, gamma_t_geo_03_gr_03_ear_03,
                    label="$\\Omega_{\\rm m}=0.3$", color="black")
                # plt.plot(thetas, gamma_t_geo_03_gr_025_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.25, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, gamma_t_geo_03_gr_035_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.35, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, gamma_t_geo_025_gr_03_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.25, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, gamma_t_geo_035_gr_03_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.35, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, gamma_t_geo_03_gr_03_ear_025,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.25$")
                # plt.plot(thetas, gamma_t_geo_03_gr_03_ear_035,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.35$")
                plt.plot(thetas, gamma_t_geo_03_gr_025_ear_03,
                    label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.25$")
                plt.plot(thetas, gamma_t_geo_03_gr_035_ear_03,
                ...
                plt.yscale('log')
                plt.legend(prop={'size': 6})
                plt.title(r'Galaxy Galaxy Lensing Bin 1-4')
                plt.savefig('gamma-t-of-theta-bin-1-4_all_2om_prefactor.png', dpi=300)
                plt.clf()
            if spectrum.name=="xip":
                theta, xip = spectrum.get_pair(4, 4)
                error = spectrum.get_error(4, 4)
                with open("thetas.pkl", "rb") as in_pkl:
                    thetas = pickle.load(in_pkl)
                with open("xi_plus_om-geo-03-growth-03-early-03.pkl", "rb") as in_pkl:
                    xi_plus_geo_03_gr_03_ear_03 = pickle.load(in_pkl)
                with open("xi_plus_om-geo-03-growth-025-early-03_prefactor.pkl", "rb") as in_pkl:
                    xi_plus_geo_03_gr_025_ear_03 = pickle.load(in_pkl)
                with open("xi_plus_om-geo-03-growth-035-early-03_prefactor.pkl", "rb") as in_pkl:
                    xi_plus_geo_03_gr_035_ear_03 = pickle.load(in_pkl)
                with open("xi_plus_om-geo-025-growth-03-early-03_prefactor_2om.pkl", "rb") as in_pkl:
                    xi_plus_geo_025_gr_03_ear_03 = pickle.load(in_pkl)
                with open("xi_plus_om-geo-035-growth-03-early-03_prefactor_2om.pkl", "rb") as in_pkl:
                    xi_plus_geo_035_gr_03_ear_03 = pickle.load(in_pkl)
                # with open("xi_plus_om-geo-03-growth-03-early-025.pkl", "rb") as in_pkl:
                #     xi_plus_geo_03_gr_03_ear_025 = pickle.load(in_pkl)
                # with open("xi_plus_om-geo-03-growth-03-early-035.pkl", "rb") as in_pkl:
                #     xi_plus_geo_03_gr_03_ear_035 = pickle.load(in_pkl)
                plt.errorbar(np.degrees(theta) * 60, xip, yerr=error,
                             marker="o", linestyle="none", label="Data Points",
                             color="grey")
                plt.plot(thetas, xi_plus_geo_03_gr_03_ear_03,
                    label="$\\Omega_{\\rm m}=0.3$", color="black")
                # plt.plot(thetas, xi_plus_geo_03_gr_025_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.25, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, xi_plus_geo_03_gr_035_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.35, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, xi_plus_geo_025_gr_03_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.25, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, xi_plus_geo_035_gr_03_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.35, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, xi_plus_geo_03_gr_03_ear_025,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.25$")
                # plt.plot(thetas, xi_plus_geo_03_gr_03_ear_035,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.35$")
                # plt.xlabel('$\\theta$')
                plt.plot(thetas, xi_plus_geo_03_gr_025_ear_03,
                    label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.25$")
                ...
                plt.yscale('log')
                plt.legend(prop={'size': 6})
                plt.title(r'Weak Lensing Bin 4-4')
                plt.savefig('xi-plus-of-theta-bin-4-4_all_2om_prefactor.png', dpi=300)
                plt.clf()
            if spectrum.name=="xim":
                theta, xim = spectrum.get_pair(4, 4)
                error = spectrum.get_error(4, 4)
                with open("thetas.pkl", "rb") as in_pkl:
                    thetas = pickle.load(in_pkl)
                with open("xi_minus_om-geo-03-growth-03-early-03.pkl", "rb") as in_pkl:
                    xi_minus_geo_03_gr_03_ear_03 = pickle.load(in_pkl)
                with open("xi_minus_om-geo-03-growth-025-early-03_prefactor.pkl", "rb") as in_pkl:
                    xi_minus_geo_03_gr_025_ear_03 = pickle.load(in_pkl)
                with open("xi_minus_om-geo-03-growth-035-early-03_prefactor.pkl", "rb") as in_pkl:
                    xi_minus_geo_03_gr_035_ear_03 = pickle.load(in_pkl)
                with open("xi_minus_om-geo-025-growth-03-early-03_prefactor_2om.pkl", "rb") as in_pkl:
                    xi_minus_geo_025_gr_03_ear_03 = pickle.load(in_pkl)
                with open("xi_minus_om-geo-035-growth-03-early-03_prefactor_2om.pkl", "rb") as in_pkl:
                    xi_minus_geo_035_gr_03_ear_03 = pickle.load(in_pkl)
                # with open("xi_minus_om-geo-03-growth-03-early-025.pkl", "rb") as in_pkl:
                #     xi_minus_geo_03_gr_03_ear_025 = pickle.load(in_pkl)
                # with open("xi_minus_om-geo-03-growth-03-early-035.pkl", "rb") as in_pkl:
                #     xi_minus_geo_03_gr_03_ear_035 = pickle.load(in_pkl)
                plt.errorbar(np.degrees(theta) * 60, xim, yerr=error,
                             marker="o", linestyle="none", label="Data Points",
                             color="grey")
                plt.plot(thetas, xi_minus_geo_03_gr_03_ear_03,
                    label="$\\Omega_{\\rm m}=0.3$", color="black")
                # plt.plot(thetas, xi_minus_geo_03_gr_025_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.25, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, xi_minus_geo_03_gr_035_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.35, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, xi_minus_geo_025_gr_03_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.25, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, xi_minus_geo_035_gr_03_ear_03,
                #     label="$\\Omega^{geo}_{\\rm m}=0.35, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.3$")
                # plt.plot(thetas, xi_minus_geo_03_gr_03_ear_025,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.25$")
                # plt.plot(thetas, xi_minus_geo_03_gr_03_ear_035,
                #     label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.3, \\Omega^{early}_{\\rm m}=0.35$")
                # plt.xlabel('$\\theta$')
                plt.plot(thetas, xi_minus_geo_03_gr_025_ear_03,
                    label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.25$")
                ...
                plt.legend(prop={'size': 6})
                plt.title(r'Weak Lensing Bin 4-4')
                plt.savefig('xi-minus-of-theta-bin-4-4_all_2om_prefactor.png', dpi=300)
                plt.clf()
