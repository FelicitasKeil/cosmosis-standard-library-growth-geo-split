...
def execute(block, config):
    ...
    with open("C_ell_shear_om-geo-03-om-growth-035.pkl", "wb") as out_pkl:
        pickle.dump(block[shear_shear, "bin_4_4"], out_pkl)

    with open("C_ell_shear_om-geo-03-om-growth-03.pkl", "rb") as in_pkl:
        C_ell_shear_geo_03_gr_03 = pickle.load(in_pkl)
    
    with open("C_ell_shear_om-geo-03-om-growth-025.pkl", "rb") as in_pkl:
        C_ell_shear_geo_03_gr_025 = pickle.load(in_pkl)

    with open("C_ell_shear_om-geo-03-om-growth-035.pkl", "rb") as in_pkl:
        C_ell_shear_geo_03_gr_035 = pickle.load(in_pkl)

    with open("C_ell_shear_om-geo-025-om-growth-03.pkl", "rb") as in_pkl:
        C_ell_shear_geo_025_gr_03 = pickle.load(in_pkl)

    with open("C_ell_shear_om-geo-035-om-growth-03.pkl", "rb") as in_pkl:
        C_ell_shear_geo_035_gr_03 = pickle.load(in_pkl)

    plt.plot(block[shear_shear, 'ell'], block[shear_shear, 'ell'] * (
        2 * block[shear_shear, 'ell'] + 1) * C_ell_shear_geo_03_gr_03,
        label="$\\Omega_{\\rm m}=0.3$", color="black")
    plt.plot(block[shear_shear, 'ell'], block[shear_shear, 'ell'] * (
        2 * block[shear_shear, 'ell'] + 1) * C_ell_shear_geo_03_gr_025,
        label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.25$")
    plt.plot(block[shear_shear, 'ell'], block[shear_shear, 'ell'] * (
        2 * block[shear_shear, 'ell'] + 1) * C_ell_shear_geo_03_gr_035,
        label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.35$")
    plt.plot(block[shear_shear, 'ell'], block[shear_shear, 'ell'] * (
        2 * block[shear_shear, 'ell'] + 1) * C_ell_shear_geo_025_gr_03,
        label="$\\Omega^{geo}_{\\rm m}=0.25, \\Omega^{growth}_{\\rm m}=0.3$")
    plt.plot(block[shear_shear, 'ell'], block[shear_shear, 'ell'] * (
        2 * block[shear_shear, 'ell'] + 1) * C_ell_shear_geo_035_gr_03,
        label="$\\Omega^{geo}_{\\rm m}=0.35, \\Omega^{growth}_{\\rm m}=0.3$")
    plt.title(r'$C_\gamma(\ell)$ autocorrelation bin 4 including IA ($\kappa$ + GI + II)')
    plt.xlabel(r'$\ell$')
    plt.ylabel(r'$\ell(2\ell+1)C_\gamma(\ell)$')
    plt.xscale('log')
    plt.yscale('log')
    plt.xlim(1, 1e6)
    plt.legend()
    plt.savefig("C_ell_shear_shear_with_IA_split.png", dpi=300)
    plt.clf()
    ...
    plt.plot(block[shear_shear, 'ell'],
             C_ell_shear_geo_03_gr_025 / C_ell_shear_geo_03_gr_03,
        label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.25$")
    plt.plot(block[shear_shear, 'ell'], 
             C_ell_shear_geo_03_gr_035 / C_ell_shear_geo_03_gr_03,
        label="$\\Omega^{geo}_{\\rm m}=0.3, \\Omega^{growth}_{\\rm m}=0.35$")
    plt.plot(block[shear_shear, 'ell'],
             C_ell_shear_geo_025_gr_03 / C_ell_shear_geo_03_gr_03,
        label="$\\Omega^{geo}_{\\rm m}=0.25, \\Omega^{growth}_{\\rm m}=0.3$")
    plt.plot(block[shear_shear, 'ell'], 
             C_ell_shear_geo_035_gr_03  / C_ell_shear_geo_03_gr_03,
        label="$\\Omega^{geo}_{\\rm m}=0.35, \\Omega^{growth}_{\\rm m}=0.3$")
    plt.title(r'Ratios of the $C_\gamma(\ell)$ autocorrelation bin 4 including IA ($\kappa$ + GI + II)')
    plt.xlabel(r'$\ell$')
    plt.ylabel(r'$C_\gamma^{rescaled}(\ell)/C_\gamma(\ell)$')
    plt.xscale('log')
    plt.xlim(1, 1e6)
    plt.legend()
    plt.savefig("C_ell_shear_shear_with_IA_split_ratio.png", dpi=300)
    plt.clf()
