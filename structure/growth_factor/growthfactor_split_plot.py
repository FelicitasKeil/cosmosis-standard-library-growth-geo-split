...
def deriv(lna, y, h0, om, om_geo, ok, w0, wa):
    ...
    hubble_0 = hubble(0, h0, om_geo, om_geo, ok, w0, wa)
    h_prime_0 = hPrimelna(0, h0, om_geo, om_geo, ok, w0, wa)
    c1_0 = 4 + h_prime_0 / hubble_0
    c2_0 = (3 + h_prime_0 / hubble_0 - 3 / 2 * om / e_z(0, h0, om, om_geo,
                                                            ok, w0, wa
                                                            ) ** 2)
    deriv[0] = y[1]
